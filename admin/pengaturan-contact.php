...
if (isset($_POST['simpan'])) {
    ...
    if (mysqli_num_rows($queryContact) > 0) {
        if (!empty($_FILES['foto']['name'])) {
            ...
            if (!in_array($extFoto, $ext)) {
                ...
                unlink('upload/' . $rowContact['foto']);
                move_uploaded_file($_FILES['foto']['tmp_name'], 'upload/' . $nama_foto);
                $update = mysqli_query($koneksi, "UPDATE contact SET address='$address', telp='$telp', email='$email' WHERE id ='$id'");
            }
        } else {
            $update = mysqli_query($koneksi, "UPDATE contact SET address='$address', telp='$telp', email='$email' WHERE id ='$id'");
        }
        ...
        if (!empty($_FILES['foto']['name'])) {
            ...
            if (!in_array($extFoto, $ext)) {
                ...
                // pindahkan gambar dari tmp folder ke folder yang sudah kita buat
                move_uploaded_file($_FILES['foto']['tmp_name'], 'upload/' . $nama_foto);
                $insert = mysqli_query($koneksi, "INSERT INTO contact (address, telp, email) VALUES ('$address','$telp','$email')");
            }
        } else {
            $insert = mysqli_query($koneksi, "INSERT INTO contact (address, telp, email) VALUES ('$address','$telp','$email')");
        }
    ...
    header("location:pengaturan-contact.php");
}
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <h3 class="card-header">Pengaturan Contact</h3>
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <input type="hidden"
                                                        class="form-control"
                                                        name="id"
                                                        value="<?php echo isset($rowContact['id']) ? $rowContact['id'] : '' ?>">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="<?php echo isset($rowContact['address']) ? $rowContact['address'] : '' ?>"
                                                            required>
                                                    </div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="<?php echo isset($rowContact['telp']) ? $rowContact['telp'] : '' ?>"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email"
                                                            ...
                                                            value="<?php echo isset($rowContact['email']) ? $rowContact['email'] : '' ?>">
